...
pub mod prover_network_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("network.ProverNetwork", "GetMarketPricePerPgu"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn get_prover_capacity(
            &mut self,
            request: impl tonic::IntoRequest<
                super::super::types::GetProverCapacityRequest,
            >,
        ) -> std::result::Result<
                ...
                "/network.ProverNetwork/GetMarketPricePerPgu" => {
                    ...
                    > for GetMarketPricePerPguSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ProverNetwork>::get_market_price_per_pgu(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/network.ProverNetwork/GetProverCapacity" => {
                    ...
                    > for GetProverCapacitySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ProverNetwork>::get_prover_capacity(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
