...
pub struct RequestProofRequestBody {
    ...
    #[prost(enumeration = "ProofVersion", tag = "2")]
    pub version: i32,
    /// The verification key.
    #[prost(bytes = "vec", tag = "3")]
    pub vkey: ::prost::alloc::vec::Vec<u8>,
    /// The mode for the proof.
    #[prost(enumeration = "ProofVariant", tag = "4")]
    pub mode: i32,
...
impl ProofVersion {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::Sp1V300Rc1 => "SP1_V3_0_0_RC1",
        }
    }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "SP1_V3_0_0_RC1" => Some(Self::Sp1V300Rc1),
            _ => None,
        }
    }
}
