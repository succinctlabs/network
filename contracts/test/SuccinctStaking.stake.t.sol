...
contract SuccinctStakingStakeTests is SuccinctStakingTest {
    ...
    function test_PermitAndStake_WhenValid() public {
        ...
        uint256 stPROVE = _permitAndStake(STAKER_1, STAKER_1_PK, ALICE_PROVER, stakeAmount, deadline);
        assertEq(stPROVE, stakeAmount);
    ...
    function testFuzz_Stake_WhenMultipleStakersSameProver(uint256 _stakeAmount1, uint256 _stakeAmount2) public {
    ...
    function testFuzz_PermitAndStake_WhenMultipleStakersDifferentProvers(uint256 _stakeAmount1, uint256 _stakeAmount2) public {
        uint256 stakeAmount1 = bound(_stakeAmount1, MIN_STAKE_AMOUNT, STAKER_PROVE_AMOUNT);
        uint256 stakeAmount2 = bound(_stakeAmount2, MIN_STAKE_AMOUNT, STAKER_PROVE_AMOUNT);
