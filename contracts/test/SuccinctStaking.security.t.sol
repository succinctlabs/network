...
contract SuccinctStakingMiscellaneousTests is SuccinctStakingTest {
    ...
    function test_BelowMinimumStake() public {
        uint256 minStake = SuccinctStaking(STAKING).minStakeAmount();
    ...
    function test_UnstakeMoreThanBalance() public {
    ...
    function test_MultiplePartialUnstakesExceedBalance() public {
        uint256 stakeAmount = STAKER_PROVE_AMOUNT;
    ...
    function test_ExactTimingBoundaries() public {
        uint256 stakeAmount = STAKER_PROVE_AMOUNT;
    ...
    function test_SlashExactTimingBoundary() public {
        uint256 stakeAmount = STAKER_PROVE_AMOUNT;
    ...
    function test_DispenseZeroTime() public {
    ...
    function test_DispenseOneWei() public {
    ...
    function test_CannotSwitchProvers() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                ISuccinctStaking.AlreadyStakedWithDifferentProver.selector,
                ALICE_PROVER
            )
        );
        vm.prank(STAKER_1);
    ...
    function test_RewardAndSlashSameBlock() public {
        uint256 stakeAmount = STAKER_PROVE_AMOUNT;
    ...
    function test_VaultReturnsZero() public {
    ...
    function test_SlashInvalidIndex() public {
        uint256 stakeAmount = STAKER_PROVE_AMOUNT;
    ...
    function test_FinishUnstakeNoClaims() public {
        uint256 stakeAmount = STAKER_PROVE_AMOUNT;
    ...
    function test_Security_MultipleUnstakeRequestsCannotDrainFunds() public {
        uint256 stakeAmount = STAKER_PROVE_AMOUNT;
    ...
    function test_Security_RoundingErrorsDoNotAccumulate() public {
    ...
    function test_Security_DustAmountsCanBeUnstaked() public {
    ...
    function test_Security_FrontrunningRewardDistribution() public {
    ...
    function test_Security_CannotAvoidSlashingByUnstaking() public {
        uint256 stakeAmount = STAKER_PROVE_AMOUNT;
    ...
    function test_Security_ExchangeRateManipulation() public {
        uint256 stakeAmount = STAKER_PROVE_AMOUNT;
    ...
    function test_Security_MaximumStakeValues() public {
    ...
    function test_Security_UnstakeQueueDoS() public {
        uint256 stakeAmount = STAKER_PROVE_AMOUNT;
    ...
    function test_Security_ZeroProverAddress() public {
    ...
    function test_Security_ConcurrentOperations() public {
    ...
    function test_Security_DispenseOverflow() public {
