...
interface ISuccinctStaking is IProverRegistry {
    ...
    /// @param iPROVE The escrowed amount of $iPROVE at request time.
    /// @param slashFactorSnapshot The slash factor for the prover when the claim was created (1e27 fp).
